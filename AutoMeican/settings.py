"""
Django settings for AutoMeican project.
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-1aqnv(fhg!el!wvr44w-ds8^xjxvvq(0r#kywg2m3%ou%q3hmn",
)
...
WSGI_APPLICATION = "AutoMeican.wsgi.application"
